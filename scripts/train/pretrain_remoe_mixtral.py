...
from routing_free.mixtral_remoe import ReMoEMixtralConfig, ReMoEMixtralForCausalLM, ReMoEMixtralModel
...
def train(
    ...
    max_length: int = 512,
    # Wandb params
    wandb_project: str = "mixtral-remoe",
    ...
    config.num_experts_per_tok = num_local_experts
...
def main():
    parser = argparse.ArgumentParser(description="Train ReMoE Mixtral model")
    ...
    parser.add_argument("--l1-coef", type=float, default=0.01,
                        help="L1 regularization coefficient for ReMoE router")
    parser.add_argument("--density-target", type=float, default=0.25,
                        help="Target density (fraction of active experts)")
    parser.add_argument("--eta-coef", type=float, default=0.02,
                        help="Adaptive lambda update rate")
    parser.add_argument("--epochs", type=int, default=1,
                        help="Number of epochs")
    parser.add_argument("--lr", type=float, default=1e-3,
                        help="Learning rate")
    parser.add_argument("--wandb-project", type=str, default="mixtral-remoe",
