...
class RoutingFreeMaskedMoE(nn.Module):
    """
    Routing-free MoE aggregator:
    - Experts return (out, gate_score), gate_score shape [B, T]
    - No top-k router; activation determined by gate_score vs threshold
    - shared_expert for dense residual FFN (optional)
    """
