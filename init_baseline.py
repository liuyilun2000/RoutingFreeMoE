...
def initialize_model(
    ...
    # Load config
    config = DeepseekV3Config.from_pretrained(config_json)
    ...
    print(f"Initializing NoAE DeepseekV3 with config: {config}")
...
def main():
    parser = argparse.ArgumentParser(description="Initialize a NoAE model")
    ...
    parser.add_argument("--n-shared-experts", type=int, required=True, help="Number of shared experts")
    parser.add_argument("--n-routed-experts", type=int, required=True, help="Number of routed experts")
